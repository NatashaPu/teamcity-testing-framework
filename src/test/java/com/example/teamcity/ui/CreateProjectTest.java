...
public class CreateProjectTest extends BaseUiTest {
    private static final String REPO_URL = "https://github.com/NatashaPu/workshop";
    ...
    public void userCreatesProject() {
        ...
        softy.assertEquals(foundProjects, true);
    }
    ...
    public void userCreatesProjectWithoutName(){
        ...
        //взаимодействие с UI
        step("Open 'Create Project Page' (http://localhost:8112/admin/createObjectMenu)");
